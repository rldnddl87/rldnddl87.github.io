...
본 포스팅은 WSL2를 설치하고 solarized 테마를 적용하는 방법에 대해서 작성하였습니다.
...
![](/assets/images/posts/2019-07-29/wsl2setup-0c8d4bee-7bac-4e62-ae18-7ba0e57359ca.png)
...
![](/assets/images/posts/2019-07-29/wsl2setup_update_error-6da922cc-fcf0-4434-a57e-98da6a916651.png)
...
![](/assets/images/posts/2019-07-29/insider_download-16906c9b-d947-4ccf-a2c7-016c531d2e0c.png)
...
![](/assets/images/posts/2019-07-29/Enableoptinal-396bb2a8-dad3-4f19-bfce-00a82007e818.png)

- 현재 설치된 wsl 하위 프로그램(Ubuntu, Debian ..)의 버전을 확인합니다
wsl -l -v

![](/assets/images/posts/2019-07-29/wsl_l_v-7fff512b-1d5d-4201-bcd7-abd7507a0e08.png)

- wsl1이 설치된 상태이기 때문에 version에 1이라고 나오겠죠?
- 설치된 wsl 하위 프로그램을 wsl2로 사용하기 위해 다음과 같이 입력합니다.
wsl --set-version <Distro> 2  
Distro 는 wsl -l -v에서 나온 이름입니다. 만일 Ubuntu라면 wsl --set-version Ubuntu 2와 같이 입력하시면 됩니다.
- 변환이 진행중이라는 말과 함께 변환이 완료됩니다.
- 다시한번 wsl -l -v을 입력하시면 1에서 2로 바뀌신걸 보실수 있습니다.
...
![](/assets/images/posts/2019-07-29/convertingerror-8dddda88-49d7-44c5-919e-73a2f392ed67.png)
...
- wsl -l -v 을 입력하면 이제는 Debian 1이라고 나오겠지요?
- wsl --set-version Debian 2 을 입력해서 Debian을 wsl2로 바꿔주고.. 다시 스토어로 가서 Ubuntu를 설치한 뒤 같은 방법으로 WSL1에서 WSL2로 바꿔 주었더니 이번에는 정상적으로 변환이 완료 되었습니다.

- 이제 default로 Debian으로 잡혀있는 wsl2를 Ubuntu로 바꿔줍니다 .
wsl --setdefault Ubuntu
- 다시 wsl -l -v 를 통해 Ubuntu 앞에 *가 붙어 있는걸 확인합니다.
...
![](/assets/images/posts/2019-07-29/checkOnUbuntu-0e32217b-e77e-4003-ba8f-804c48f07762.png)
...
oh-my-zsh는 사용자가 입력해두었던 쉘 스크립트를 기반으로 명령어를 추천해주고, git과 연동되는 등 다양한 플로그인을 지원합니다.

- 먼저 zsh를 설치합니다.
sudo apt-get install zsh
zsh --version으로 정상적으로 설치 되었는지 확인합니다.

![](/assets/images/posts/2019-07-29/zsh_version-16594747-6e78-4ce3-8cec-ba6acdc2c470.png)

- bash로 설정되어 있는 기본 쉘을 zsh로 변경합니다.
chsh -s /usr/bin/zsh
터미널을 종료한뒤 다시 시작합니다.
만일 옵션을 선택하는 창이 뜬다면 2번 선택합니다. 어떠한 옵션을 선택하더라도 oh-my-zsh를 설치하면 overwritten되기 때문에 크게 상관은 없습니다.
- oh-my-zsh를 설치합니다.
...
![](/assets/images/posts/2019-07-29/1---Install-oh-my-zsh-ac5adadc-b9f1-4850-8818-e622749587db.png)

- oh-my-zsh와 관련된 설정 파일은 $HOME/.zshrc파일에 작성됩니다.
- 아직도 칙칙하고 어두운 화면이겠죠?
- 기본 테마를 변경합니다.

    .zshrc파일을 열어 ZSH_THEME="robbyrussell"인 부분을 agnoster로 변경합니다.

    쉘을 재시작합니다.

- echo "\ue0b0 \u00b1 \ue0a0 \u27a6 \u2718 \u26a1 \u2699 와 같이 입력하였을때 이미지와 같이 나와야 합니다. 정상적으로 출력이 되지 않을 경우 폰트를 설치해야 합니다.

![](/assets/images/posts/2019-07-29/characters-e36a11dc-47cc-4a22-bc8a-9c82eeb6afc9.png)
...
![](/assets/images/posts/2019-07-29/ugly-dircolors-3925f052-7ca7-4609-bb4d-8e37e8b0f23b.png)
...
![](/assets/images/posts/2019-07-29/pretty-terminal-ce32819d-3c74-4a09-9aae-02ea8f521d82.png)
...
- 설정
    ...
    ![](/assets/images/posts/2019-07-29/my_zsh_conf-788455c1-48a5-4ce0-bba6-1e094194ae83.png)
...
![](/assets/images/posts/2019-07-29/ConEmu_Tasks-19a82159-c321-478e-9c68-e9c515ff2704.png)

![](/assets/images/posts/2019-07-29/Conemu_General-70b42077-7c0e-45a2-ad6e-cee4e77c8a13.png)

![](/assets/images/posts/2019-07-29/Conemu_integration-f4573416-50e8-4930-a5ef-a432c4a32821.png)

![](/assets/images/posts/2019-07-29/Conemu_font-b68df714-f4e4-4a66-8377-100b3e5a58e1.png)
...
![](/assets/images/posts/2019-07-29/myConemu-718c9f8c-0cc1-4a77-9348-e18549fe6bac.png)

![](/assets/images/posts/2019-07-29/myUbuntu-c2a848ee-90a1-49a0-9824-b100d1ff40f4.png)
